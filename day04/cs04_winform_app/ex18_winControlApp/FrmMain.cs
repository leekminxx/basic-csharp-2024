...
namespace ex18_winControlApp
{
    public partial class FrmMain : Form
    {
        ...
        private void BtnModaless_Click(object sender, EventArgs e)
        {
            ...
            FrmModalless.Show(this); // 모달리스창 띄우기
        }
        ...
        private void BtnAddChild_Click(object sender, EventArgs e)
        {
            ...
            { // 부모노드를 선택하지 않으면
                MessageBox.Show("선택한노드가 없음.", "경고", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void BtnThread_Click(object sender, EventArgs e)
        {
            ...
            BtnThread.Enabled = BtnNothread.Enabled = true; // 진행사항 리포트 활성화 
            BtnStop.Enabled = true;  //백그라운드워커 취소 활성화
...

        {
            ...
            for (var i = 0; i <= maxValue; i++)
            {
                ...
                else
                {
                    ...
                    // 아래를 실행ㅎ면 , BgwProgress_ProgressChanged 이벤트핸들러의
